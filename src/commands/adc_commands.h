...
void doGetU();                    // 0x11   Читать текущее напряжение (мВ)
void doGetI();                    // 0x12   Читать текущий ток (мА)
void doGetUI();                   // 0x13   Читать текущее напряжение (мВ) и ток (мА)
void doGetState();                // 0x14   Читать текущее состояние
